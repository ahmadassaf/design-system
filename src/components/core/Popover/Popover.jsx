...
export const PopoverContent = ({ children, className, id }) => (
  <div id={ id } className={ cn('absolute left-0 top-full z-50 mt-2 w-72 rounded-lg border border-gray-200 bg-white p-4 text-sm text-gray-700 shadow-lg dark:border-gray-800 dark:bg-gray-950 dark:text-gray-200', className) }>
    {children}
  </div>
);
